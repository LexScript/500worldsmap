window.definitions = {
    worlds: [
        ...
        {id: 4, name: 'Tarkad Vindix', system: 'Relis', position: {x: 2428.33, y: 678.91}, infrastructure: 2},
        {id: 5, name: 'Yawardet', system: 'Esvar', position: {x: 3218.62, y: 791.96}, infrastructure: 3},

        {id: 6, name: 'Karabas', system: 'Salen', position: {x: 126.98, y: 1368.09}, infrastructure: 2},
        {id: 7, name: 'Kryndar', system: 'Zur Mortalis', position: {x: 1002.58, y: 1170.11}, infrastructure: 3},
        {id: 8, name: 'Novamagnor', system: 'Heliodas', position: {x: 1911.35, y: 1337.36}, infrastructure: 2},
        {id: 9, name: 'Astarem', system: 'Ophros', position: {x: 2787.16, y: 1391.07}, infrastructure: 3},

        {id: 10, name: 'Marvinus', system: 'Diodecis', position: {x: 488.95, y: 2262.42}, infrastructure: 2},
